...
> = {
  speaker1: {
    ...
    bubbleBg: 'bg-white/60 dark:bg-slate-800/60 glass',
  ...
  me: {
    ...
    avatarText: 'text-slate-700 dark:text-slate-300',
    bubbleBg: 'bg-white/60 dark:bg-slate-800/60 glass',
    translationColor: 'text-slate-500 dark:text-slate-400',
    dividerColor: 'border-slate-200 dark:border-slate-700',
  },
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col min-w-0 ${isRight ? 'items-end' : 'items-start'}`}>
        <div
          className={`rounded-2xl px-3.5 py-2.5 max-w-xs sm:max-w-sm border border-dashed border-slate-300 dark:border-slate-700 bg-white/40 dark:bg-slate-800/30 ${isRight ? 'rounded-tr-sm' : 'rounded-tl-sm'}`}
        >
  ...
  return (
    ...
    >
      ...
      {showRecordingIndicator && (
        <div className="flex items-center gap-2 px-3 py-2 mx-2 mb-1 rounded-xl bg-red-50/60 dark:bg-red-900/15 border border-red-100/60 dark:border-red-500/10 w-fit">
